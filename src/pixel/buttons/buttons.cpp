...
Buttons::initialize(std::shared_ptr<Logger> logger)
{
    ...
    attachInterrupt(digitalPinToInterrupt(static_cast<int>(ESP32Pin::joystick_up)),
            Buttons::setJoystickUp, CHANGE);
    attachInterrupt(digitalPinToInterrupt(static_cast<int>(ESP32Pin::joystick_down)),
            Buttons::setJoystickDown, CHANGE);
    attachInterrupt(digitalPinToInterrupt(static_cast<int>(ESP32Pin::joystick_left)),
            Buttons::setJoystickLeft, CHANGE);
    attachInterrupt(digitalPinToInterrupt(static_cast<int>(ESP32Pin::joystick_right)),
            Buttons::setJoystickRight, CHANGE);
    attachInterrupt(digitalPinToInterrupt(static_cast<int>(ESP32Pin::joystick_click)),
            Buttons::setJoystickClick, CHANGE);
    attachInterrupt(digitalPinToInterrupt(static_cast<int>(ESP32Pin::pushbutton_left)),
            Buttons::setPushbuttonLeft, CHANGE);
    attachInterrupt(digitalPinToInterrupt(static_cast<int>(ESP32Pin::pushbutton_right)),
...
Buttons::setJoystickDown()
{
    states_->joystick_down = !static_cast<bool>(digitalRead(
            static_cast<int>(ESP32Pin::joystick_down)));
}
...
Buttons::setJoystickLeft()
{
    states_->joystick_left = !static_cast<bool>(digitalRead(
            static_cast<int>(ESP32Pin::joystick_left)));
}
...
Buttons::setJoystickRight()
{
    states_->joystick_right = !static_cast<bool>(digitalRead(
            static_cast<int>(ESP32Pin::joystick_right)));
}
...
Buttons::setJoystickClick()
{
    states_->joystick_click = !static_cast<bool>(digitalRead(
            static_cast<int>(ESP32Pin::joystick_click)));
}
...
Buttons::setPushbuttonLeft()
{
    states_->pushbutton_left = !static_cast<bool>(digitalRead(
            static_cast<int>(ESP32Pin::pushbutton_left)));
}
...
Buttons::setPushbuttonRight()
{
    states_->pushbutton_right = !static_cast<bool>(digitalRead(
            static_cast<int>(ESP32Pin::pushbutton_right)));
}
} // namespace kano_pixel_kit
